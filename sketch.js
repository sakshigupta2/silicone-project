...
function setup() {
 ...
 wall1.scale = 3.0;
    ...
    invisible = createSprite(20,700,20,100);
    invisible.visible = false;
    invisible.shapeColor = "red";
    

    invisible2= createSprite(1480,700,20,100);
    ...
    step = createSprite(750,340,10,10);
...
chand.visible = false;
  ...
  pic = createSprite(300,480,10,10);
  pic.addImage(picImg);
  pic.visible = false;
  pic.scale = 0.23;
